...
{
  DIO_VoidSet_Pin_Direction(Copy_u8Port, Copy_u8Pin, Output);
  switch (Copy_u8Direction)
  {
  case 0:
    DIO_VoidSet_Pin_Value(Copy_u8Port, Copy_u8Pin, Low);
    break;
  case 1:
    DIO_VoidSet_Pin_Value(Copy_u8Port, Copy_u8Pin, High);
    break;
  }
}
...
#if TIMER_0_MODE == TIMER_0_NORMAL_MODE_SET
...
#elif TIMER_0_MODE == TIMER_0_PWM_PHASE_CORRECT_MODE_SET
...
#elif TIMER_0_MODE == TIMER_0_CTC_MODE_SET
  TCCR0 |= TIMER_0_CTC_MODE_SET;                       /*Set CTC Mode*/
  TCCR0 |= (TIMER_0_NON_PWM_COMPARE_OUTPUT_MODE << 4); /* Set Compare Output Mode */
  TCNT0 = TIMER_0_PRELOAD_VALUE;                       /* Set PreLoad Value */
  OCR0 = TIMER_0_COMPARE_MATCH_VALUE;                  /* Ser Compare Match Value */
#elif TIMER_0_MODE == TIMER_0_FAST_PWM_MODE_SET
...
void TIMER0_VoidSetDuty(u8 Copy_u8Duty)
{
  OCR0 = ((Copy_u8Duty * 265) / 100);
}
...
void TIMER1_VidSetServo_AngleWith_OCR1BL(u16 Copy_u8AngleValue)
{

  OCR1B = ((Copy_u8AngleValue) * (1700 / 180)) + 650;
}
...
void TIMER1_Vid_ICU_Init(void)
{
  /* Set ICES1 As Rising Edge and Noise Cancceler */
  Timer1_VoidICUNoiseCancellerEnable();
  Timer1_VoidICUSetTriggerEdge(TIMER_1_INPUTCAPTURE_RISINGEDGE); /* Set ICU Interrupt */
  Timer1_VoidICUInterruptEnable();

  /*Set a Pre-scaler divided by 8 */
  TCCR1B &= 0b11111000;
  TCCR1B |= 2;
}
...
void TIMER2_VoidSetDuty(u8 Copy_u8Duty)
{
  OCR2 = ((Copy_u8Duty * 265) / 100);
}
...
void RightMotor_VoidControlledSpeed(u16 Copy_u8SpeedIntensity)
{
  TIMER0_VoidSetDuty(100 - Copy_u8SpeedIntensity);
}

void LeftMotor_VoidControlledSpeed(u16 Copy_u8SpeedIntensity)
{
  TIMER2_VoidSetDuty(100 - Copy_u8SpeedIntensity);
}
